                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form action="#">
                                                            ...
                                                            <div class="single-input">
                                                                <input type="number" name="mobile" id="mobile" placeholder="Your Mobile*" style="width:100%" maxlength="10" size="10">
										...
										<div class="accordion__body">
											<div class="bilinfo">
													...
													<div class="row">
														...
														<div class="col-md-6">
															<div class="single-input">
																<input type="number" name="pincode" id="pincode" placeholder="Post code/ zip" maxlength="6" size="6" required>
															</div>
														</div>
